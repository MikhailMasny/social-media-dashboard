...
namespace SocialMediaDashboard.Application.Interfaces
{
    ...
    //    Task<(AccountDto accountDto, AccountResult accountResult)> CreateAccountByUserIdAsync(string userId, string account, AccountKind accountType);
    ...
    //    /// <param name="accountType">Account type.</param>
    //    /// <returns>Account operation result.</returns>
    //    Task<AccountResult> UpdateAccountByUserIdAsync(string userId, int accountId, string accountName, AccountKind accountType);
