...
namespace SocialMediaDashboard.Infrastructure.Services
{
    ...
    //        var subscriptions = await _subscriptionService.GetAllSubscriptionsByTypeAsync(AccountKind.Vk, SubscriptionKind.Follower);
    ...
    //    {
    //        var statistics = new List<Statistic>();
    //        var subscriptions = await _subscriptionService.GetAllSubscriptionsByTypeAsync(AccountKind.Instagram, SubscriptionKind.Follower);
    ...
    //    {
    //        var statistics = new List<Statistic>();
    //        var subscriptions = await _subscriptionService.GetAllSubscriptionsByTypeAsync(AccountKind.YouTube, SubscriptionKind.Subscriber);
